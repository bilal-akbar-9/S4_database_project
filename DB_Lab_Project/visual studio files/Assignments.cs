            ...
            try
            {
                ...
                else
                {
                    ...
                    while (dr.Read())
                    {
                        ...
                        p.Scale(new SizeF(1.5f, 1.5f));
                        p.Name = dr["assignmentID"].ToString();
                        Debug.WriteLine(dr["assignmentID"].ToString());

                        Label lbl = new Label();

                        lbl.Text = "Assignment ID: " + dr["assignmentID"].ToString();
                        ...
                        lbl2.Text = dr["assignmentDescription"].ToString();
                        ...
                        p.Controls.Add(lbl2);
                        p.Controls.Add(lbl);
                        flowLayoutAssignment.Controls.Add(p);
                        p.Click += (s, ev) =>
                        {
